...
**Legend:**
- **Tasks**: T=Text Extract, L=Layout, O=OCR, S=Structured, Tab=Table, F=Formula, Chart=Chart Understanding
...
**HuggingFace**: [deepseek-ai/DeepSeek-OCR-2](https://huggingface.co/deepseek-ai/DeepSeek-OCR-2)
...
- Strong document understanding beyond text extraction

**Backends Supported**:
- ✅ PyTorch (HuggingFace Transformers)
- ✅ VLLM (high throughput)
- ✅ MLX (4-bit, 8-bit)
- ✅ API (Novita AI, OpenRouter)
...
**HuggingFace**: [lightonai/LightOnOCR-2-1B](https://huggingface.co/lightonai/LightOnOCR-2-1B)
...
**Key Features**:
- **83.2 on OlmOCR-Bench** (SOTA, beats 9B Chandra)
- 5.7 pages/second on H100 (~493K pages/day)
- <$0.01 per 1,000 pages at cloud pricing
- Bbox variant for figure/image localization
