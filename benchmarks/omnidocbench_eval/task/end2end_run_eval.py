...
from registry.registry import EVAL_TASK_REGISTRY, METRIC_REGISTRY
    ...
    def __init__(self, dataset, metrics_list, page_info_path, save_name):
        ...
        if not md_flag:
            ...
            for page in pages:
                ...
                # Strip extension only if one exists
                img_key = img_path[:-4] if img_path.lower().endswith((".jpg", ".jpeg", ".png", ".pdf")) else img_path
                page_info[img_key] = page["page_info"]["page_attribute"]
