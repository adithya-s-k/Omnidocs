"""
PaddleOCR Extraction - GPU

Standalone test script. Run locally with GPU or via Modal runner.

Usage:
    python -m tests.standalone.ocr_extraction.paddleocr_gpu path/to/image.png
"""
...
class PaddleOCRGPUTest(BaseOmnidocsTest):
    ...
    def create_extractor(self) -> Any:
        ...
        return PaddleOCR(config=PaddleOCRConfig(lang="en", device="gpu"))
...
if __name__ == "__main__":
    run_standalone_test(PaddleOCRGPUTest)
