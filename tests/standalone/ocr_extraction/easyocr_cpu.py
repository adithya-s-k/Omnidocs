"""
EasyOCR Extraction - CPU

Standalone test script. Run locally on CPU.

Usage:
    python -m tests.standalone.ocr_extraction.easyocr_cpu path/to/image.png
"""
...
class EasyOCRCPUTest(BaseOmnidocsTest):
    ...
    def create_extractor(self) -> Any:
        ...
        return EasyOCR(config=EasyOCRConfig(languages=["en"], gpu=False))
...
if __name__ == "__main__":
    run_standalone_test(EasyOCRCPUTest)
