...
Usage:
    python -m tests.standalone.text_extraction.dotsocr_vllm path/to/image.png
"""
...
class DotsOCRTextVLLMTest(BaseOmnidocsTest):
    """Test DotsOCR text extraction with VLLM backend."""

    @property
    def test_name(self) -> str:
        return "dotsocr_text_vllm"
...
if __name__ == "__main__":
    run_standalone_test(DotsOCRTextVLLMTest)
