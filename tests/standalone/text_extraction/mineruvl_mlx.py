"""
MinerU VL Text Extraction - MLX Backend (Apple Silicon)

Standalone test script. Run locally on Apple Silicon Mac.

Usage:
    python -m tests.standalone.text_extraction.mineruvl_mlx path/to/image.png
"""
...
class MinerUVLTextMLXTest(BaseOmnidocsTest):
    """Test MinerU VL text extraction with MLX backend."""

    @property
    def test_name(self) -> str:
        return "mineruvl_text_mlx"
    ...
    def create_extractor(self) -> Any:
        ...
        return MinerUVLTextExtractor(backend=MinerUVLTextMLXConfig())
...
if __name__ == "__main__":
    run_standalone_test(MinerUVLTextMLXTest)
