...
Usage:
    python -m tests.standalone.text_extraction.dotsocr_pytorch path/to/image.png
"""
...
class DotsOCRTextPyTorchTest(BaseOmnidocsTest):
    """Test DotsOCR text extraction with PyTorch backend."""

    @property
    def test_name(self) -> str:
        return "dotsocr_text_pytorch"
    ...
    def create_extractor(self) -> Any:
        ...
        return DotsOCRTextExtractor(backend=DotsOCRPyTorchConfig())
...
if __name__ == "__main__":
    run_standalone_test(DotsOCRTextPyTorchTest)
