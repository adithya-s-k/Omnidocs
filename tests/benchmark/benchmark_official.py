...
Usage:
    # Run all models
    modal run tests/benchmark/benchmark_official.py

    # Run specific models
    modal run tests/benchmark/benchmark_official.py --models glmocr,dotsocr,nanonets

    # Limit pages (fast iteration)
    modal run tests/benchmark/benchmark_official.py --max-samples 10 --models glmocr

    # Custom output dir (default: results/omnidocbench/<run_id>/)
    modal run tests/benchmark/benchmark_official.py --output-dir results/run_01
...
# ---------------------------------------------------------------------------
# Images — identical to existing benchmark_official.py
# ---------------------------------------------------------------------------
...
@app.function(image=PYTORCH_IMAGE, gpu="L40S:1", secrets=[secret], timeout=3600)
